  ...
  <div class="container-fluid navModal">
    <div class="row p-sm-5">
      <div class="col-12 col-lg-4" :class="classList.navBar">
        <router-link to="/" class="text-decoration-none textColor">
        ...
        <ul class="list-unstyled d-flex justify-content-center align-items-center h-100">
          <li>
            <router-link to="/front/articles" class="text-decoration-none d-flex">
              <div class="d-flex align-items-center hvr-icon-float-in text-dark">
      ...
      <div class="col-4 d-none d-lg-block">
        <ul class="list-unstyled d-flex justify-content-center align-items-center h-100">
          <li>
            <router-link to="/front/qa" class="text-decoration-none text-dark"
              >相關問題</router-link
            >
          </li>
          <li class="mx-5">
            <div class="dropdown">
              <button
                class="dropdown-toggle btn btn-link text-dark text-decoration-none"
                type="button"
                @click="toggleModal"
...
export default {
  ...
  mounted() {
    ...
    window.addEventListener('scroll', () => {
      ...
      if (windowY > 100) {
        this.classList = {
          navBar: 'navSet textColor bg-dark',
        };
      } else {
        this.classList = {
          navBar: 'navSet',
